...
const CourseDetailItem = ({ thumbnail, title, description }: CourseDetailItemProps) => {
  return (
    <CourseDetailItemWrapper>
      ...
      <div className="edu--course-detail-item-info">
        ...
        <div className="edu--course-detail-item-info-description" dangerouslySetInnerHTML={{ __html: description }} />
      </div>
    </CourseDetailItemWrapper>
  );
};

...
export const topAreaTitle = style(["text-base", "font-bold", "h-4", "leading-4"]);
...
export const topAreaLinks = style(["flex", "flex-col", "bg-white", "py-2", "border-b"]);

export const topAreaLink = [
  style(["flex", "flex-row", "text-base", "text-gray-600", "py-2", "px-3", "justify-between"]),
